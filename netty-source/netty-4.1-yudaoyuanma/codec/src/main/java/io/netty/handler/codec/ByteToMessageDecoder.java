...
public abstract class ByteToMessageDecoder extends ChannelInboundHandlerAdapter {
     ...
     * 
     * <p> 一旦应从给定的ByteBuf解码数据就调用。 只要解码应发生，此方法将调用解码（ChannelHandlerContext，ByteBuf，列表）。
     *
     * @param ctx           the {@link ChannelHandlerContext} which this {@link ByteToMessageDecoder} belongs to
     * 
     * <p> ByteToMessageDecoder所属的ChannelHandlerContext
     * 
     ...
     * {@link ByteBuf}.
     * 
     * <p> 从一个ByteBuf解码到另一个。 直到从该方法返回时输入ByteBuf没有内容要读取或从输入ByteBuf中没有读取任何内容为止，将一直调用此方法。
     *
     * @param ctx           the {@link ChannelHandlerContext} which this {@link ByteToMessageDecoder} belongs to
     * 
     * <p> ByteToMessageDecoder所属的ChannelHandlerContext
     ...
     * {@link ByteBuf}.
     * 
     * <p> 从一个ByteBuf解码到另一个。 直到从该方法返回时输入ByteBuf没有内容要读取或从输入
     * ByteBuf中没有读取任何内容为止，将一直调用此方法。
     *
     * @param ctx           the {@link ChannelHandlerContext} which this {@link ByteToMessageDecoder} belongs to
     * 
     * <p> ByteToMessageDecoder所属的ChannelHandlerContext
