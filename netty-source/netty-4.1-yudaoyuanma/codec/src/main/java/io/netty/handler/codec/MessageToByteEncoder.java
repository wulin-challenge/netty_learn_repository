 ...
 * {@link ByteBuf}.
 *
 * <p> ChannelOutboundHandlerAdapter，它以类似流的方式将消息从一条消息编码到ByteBuf。
 *
 * <p> Example implementation which encodes {@link Integer}s to a {@link ByteBuf}.
 * 
 * <p> 将整数编码为ByteBuf的示例实现。
 *
 * <pre>
...
public abstract class MessageToByteEncoder<I> extends ChannelOutboundHandlerAdapter {
     ...
     * 
     * <p> 如果应该处理给定的消息，则返回true。 如果为false，它将被传递到ChannelPipeline中的下一个ChannelOutboundHandler。
     */
