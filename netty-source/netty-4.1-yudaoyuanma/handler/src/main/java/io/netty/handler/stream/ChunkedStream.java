 ...
 * chunk.
 * 
 * <p> 一个ChunkedInput，它逐块从InputStream中获取数据。
 * 
 * <p>
 ...
 * 
 * <p> 请注意，将数据馈送到ChunkedStream的InputStream实例必须尽可能准确地实现
 * InputStream.available（），而不是使用默认实现。 
 * 否则，ChunkedStream将生成太多的小块或不必要地频繁阻塞。
 */
