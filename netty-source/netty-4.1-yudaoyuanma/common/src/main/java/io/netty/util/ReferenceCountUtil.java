 ...
 * 
 * <p> 处理可能实现ReferenceCounted的对象的方法的集合。
 */
public final class ReferenceCountUtil {
     ...
     * 
     * <p> 如果指定的消息实现了ReferenceCounted，则尝试调用ReferenceCounted.touch（Object）。 
     * 如果指定的消息未实现ReferenceCounted，则此方法不执行任何操作。
     */
    @SuppressWarnings("unchecked")
     ...
     * If the specified message doesn't implement {@link ReferenceCounted}, this method does nothing.
     * 
     * <p> 如果指定的消息实现了ReferenceCounted，请尝试调用ReferenceCounted.release（）。 
     * 如果指定的消息未实现ReferenceCounted，则此方法不执行任何操作。
     */
