 ...
 * 
 * <p> （仅用于传输实现者）AbstractChannel用于存储其挂起的出站写请求的内部数据结构。
 * 
 * <p>
 * All methods must be called by a transport implementation from an I/O thread, except the following ones:
 * 
 * <p> 除以下方法外，所有方法都必须由I / O线程的传输实现调用：
 * 
 * <ul>
...
public final class ChannelOutboundBuffer {
     ...
     * 
     * <p> 将给定消息添加到此ChannelOutboundBuffer。 写入消息后，将通知给定的ChannelPromise。
     */
     ...
     * 
     * <p> 向此ChannelOutboundBuffer添加刷新。 这意味着以前添加的所有消息都标记为已刷新，因此您将能够处理它们。
     */
