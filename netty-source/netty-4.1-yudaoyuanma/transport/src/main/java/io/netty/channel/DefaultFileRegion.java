 ...
 *
 * <p> 默认的FileRegion实现，可从FileChannel或File传输数据。
 * 
 * <p> Be aware that the {@link FileChannel} will be automatically closed once {@link #refCnt()} returns
 * {@code 0}.
 * 
 * <p> 请注意，一旦refCnt（）返回0，FileChannel将自动关闭。
 */
