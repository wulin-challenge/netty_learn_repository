...
public abstract class AbstractBootstrap<B extends AbstractBootstrap<B, C>, C extends Channel> implements Cloneable {
     ...
     * 
     * <p> 用于从中创建Channel实例的Class。 如果您的Channel实现没有no-args构造函数，
     ...
     * 
     * <p> 创建通道实例后，允许指定一个ChannelOption。 使用null值删除以前设置的ChannelOption。
     */
     ...
     * 
     * <p> 允许指定新创建的Channel的初始属性。 如果该值为null，则删除指定键的属性。
     */
     ...
     * 
     * <p> 验证所有参数。 子类可以重写此方法，但在这种情况下应调用super方法。
     */
    public B validate() {
        if (group == null) {
     ...
     * 
     * <p> 返回具有相同配置的此引导程序的深层克隆。 当使用相似的设置制作多个通道时，此方法很有用。 
     * 请注意，此方法不会深深地克隆EventLoopGroup，而是将其克隆为共享资源。
     */
    @Override
            ...
            regFuture.addListener(new ChannelFutureListener() {
                ...
                public void operationComplete(ChannelFuture future) throws Exception {
                    ...
                    if (cause != null) {
                    	...
                    	// 在EventLoop上的注册失败，因此一旦我们尝试访问Channel的EventLoop，
                    	// 就直接使ChannelPromise失败，不会导致IllegalStateException。
     ...
     * of the bootstrap.
     * 
     * <p> 返回AbstractBootstrapConfig对象，该对象可用于获取引导程序的当前配置。
     */
